...
<link
	href="${pageContext.request.contextPath}/resources/home/css/bootstrap.css"
	rel='stylesheet' type='text/css' />
<!-- jQuery (necessary JavaScript plugins) -->
<script type='text/javascript'
	src="${pageContext.request.contextPath}/resources/home/js/jquery-1.11.1.min.js"></script>
<!-- Custom Theme files -->
<link
...
<!-- start menu -->
<link
	href="${pageContext.request.contextPath}/resources/home/css/megamenu.css"
	rel="stylesheet" type="text/css" media="all" />

<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/home/js/megamenu.js"></script>
<script>
