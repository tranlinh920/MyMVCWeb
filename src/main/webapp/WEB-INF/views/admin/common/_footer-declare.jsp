...
<script
	src="${pageContext.request.contextPath}/resources/plugin/jquery.twbsPagination.js"></script>

<script
	src="${pageContext.request.contextPath}/resources/plugin/ckeditor/ckeditor.js"></script>

<script
	src="${pageContext.request.contextPath}/resources/plugin/medium-zoom/js/zoom.js"></script>
